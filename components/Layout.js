...
const Layout = ({ children }) => {
  ...
  const [navigation, setNavigation] = useState([
    ...
    {
      name: 'Polls', href: '#', icon: ServerIcon, current: false,
      subMenu: [
        { name: 'Create', href: '#', icon: PlusCircleIcon, current: false },
        { name: 'All Polls', href: '#', icon: QueueListIcon, current: false },
        { name: 'Scheduled', href: '#', icon: ClockIcon, current: false },
        { name: 'Ongoing', href: '#', icon: ArrowsUpDownIcon, current: false }
      ]
    },
    { name: 'Analytics', href: '#', icon: SignalIcon, current: false },
    { name: 'Setting', href: '#', icon: GlobeAltIcon, current: false },
    { name: 'Notification', href: '#', icon: ChartBarSquareIcon, current: false },
  ]);

  const handleNavigationClick = (index) => {
    const updatedNavigation = [...navigation]; // Create a copy of the array
    updatedNavigation[index].current = !updatedNavigation[index].current; // Toggle the 'current' field
    setNavigation(updatedNavigation); // Update the state with the modified array
  };
